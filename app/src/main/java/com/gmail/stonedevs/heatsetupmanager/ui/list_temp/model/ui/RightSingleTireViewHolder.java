...
public class RightSingleTireViewHolder extends RecyclerView.ViewHolder {
    private final TireLayoutSingleRightBinding binding;
    private TireTempViewModel viewModel;

    public RightSingleTireViewHolder(@NonNull TireLayoutSingleRightBinding binding) {
